...
class Player extends Phaser.GameObjects.Sprite {
  ...
  update(delta) {
    ...
    if (this.scene.cursor.space.isDown && this.canShoot) {
      ...
      this.bow.setRotation(this.lastDirection === Player.PLAYER_RIGHT_DIRECTION ? Math.PI / 4 : Math.PI * 3/4);
    }
  ...
  aim(delta) {
    ...
    this.bow.setRotation(this.lastDirection === Player.PLAYER_RIGHT_DIRECTION ?
       -this.aimAngle + Math.PI / 2 : Math.PI * 2/4 + this.aimAngle);
